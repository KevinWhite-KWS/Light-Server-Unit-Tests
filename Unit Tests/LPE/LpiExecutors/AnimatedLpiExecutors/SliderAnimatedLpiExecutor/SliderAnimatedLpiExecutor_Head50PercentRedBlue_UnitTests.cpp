	...
	namespace LPE {
		namespace LpiExecutors {
			namespace Slider {
				...
				{
				public:
					TEST_METHOD(WhenHead50PercentRedBlueStep1_RIsSet)
					{
						// arrange
						LpiExecutor_Tester tester("030100000203200FF00000000FF", 10);
					...
					TEST_METHOD(WhenHead50PercentRedBlueStep2_RIsSet)
					{
						// arrange
						LpiExecutor_Tester tester("030100000203200FF00000000FF", 10);
						SliderAnimatedLpiExecutor lpiExecutor;
					...
					TEST_METHOD(WhenHead50PercentRedBlueStep5_RIsSet)
					{
						// arrange
						LpiExecutor_Tester tester("030100000203200FF00000000FF", 10);
						SliderAnimatedLpiExecutor lpiExecutor;
					...
					TEST_METHOD(WhenHead50PercentRedBlueStep8_RIsSet)
					{
						// arrange
						LpiExecutor_Tester tester("030100000203200FF00000000FF", 10);
						SliderAnimatedLpiExecutor lpiExecutor;
					...
					TEST_METHOD(WhenHead50PercentRedBlueStep9_RIsSet)
					{
						// arrange
						LpiExecutor_Tester tester("030100000203200FF00000000FF", 10);
						SliderAnimatedLpiExecutor lpiExecutor;
