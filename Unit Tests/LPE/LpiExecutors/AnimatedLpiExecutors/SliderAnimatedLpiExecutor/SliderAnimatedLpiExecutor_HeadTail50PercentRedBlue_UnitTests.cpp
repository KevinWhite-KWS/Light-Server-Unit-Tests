...
#define LPI	"030100000203232FF00000000FF"
	...
	namespace LPE {
		namespace LpiExecutors {
			namespace Slider {
				...
				{
				public:
					TEST_METHOD(WhenHeadTail50PercentRedBlueStep1_RIsSet)
					{
						// arrange
					...
					TEST_METHOD(WhenHeadTail50PercentRedBlueStep2_RIsSet)
					{
						// arrange
						LpiExecutor_Tester tester(LPI, 10);
						SliderAnimatedLpiExecutor lpiExecutor;
					...
					TEST_METHOD(WhenHeadTail50PercentRedBlueStep5_RIsSet)
					{
						// arrange
						LpiExecutor_Tester tester(LPI, 10);
						SliderAnimatedLpiExecutor lpiExecutor;
					...
					TEST_METHOD(WhenHeadTail50PercentRedBlueStep8_RIsSet)
					{
						// arrange
						LpiExecutor_Tester tester(LPI, 10);
						SliderAnimatedLpiExecutor lpiExecutor;
					...
					TEST_METHOD(WhenHeadTail50PercentRedBlueStep9_RIsSet)
					{
						// arrange
						LpiExecutor_Tester tester(LPI, 10);
						SliderAnimatedLpiExecutor lpiExecutor;
